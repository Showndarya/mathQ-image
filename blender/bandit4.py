...
bpy.context.scene.render.filepath = os.path.join(output_dir, "rendered_image_4.png")
...
if armature_obj:
    ...
    if thumb_proximal_l_bone and thumb_middle_l_bone and thumb_distal_l_bone:
        ...
        thumb_proximal_l_bone.rotation_euler.rotate_axis('Y', 1.0)  # 57.3 degrees in radians
