...
if armature_obj:
    ...
    if thumb_proximal_l_bone and thumb_middle_l_bone and thumb_distal_l_bone:
        ...
        thumb_proximal_l_bone.rotation_euler.rotate_axis('X', -0.785) # -45 degrees in radians
        thumb_middle_l_bone.rotation_euler.rotate_axis('X', -0.785) # -45 degrees in radians
        thumb_distal_l_bone.rotation_euler.rotate_axis('X', -0.785) # -45 degrees in radians
